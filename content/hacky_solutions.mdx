...
If GitHub, GitLab, and BitBucket are all blocked, you can make one repo in a cloud service for your club, give all your members a folder, and have them use that for version control.
